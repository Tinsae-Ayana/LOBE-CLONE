         ...
         <div className='flex justify-between lg:flex-row items-start py-4 px-7 relative'>
            ...
            >
               ...
               <div className='flex  lg:flex-row flex-col justify-evenly w-1/2 lg:px-2 px-0 space-y-7 lg:space-y-0' onClick={showNav}>
                  <NavLink to='LOBE-CLONE//' className={({ isActive }) => (isActive ? activeDec : notActiveDec)}>
                     Overview
                  </NavLink>
                  <NavLink to='LOBE-CLONE//Example' className={({ isActive }) => (isActive ? activeDec : notActiveDec)}>
                     Examples
                  </NavLink>
                  <NavLink to='LOBE-CLONE//Tour' className={({ isActive }) => (isActive ? activeDec : notActiveDec)}>
                     Tour
                  </NavLink>
                  <NavLink to='LOBE-CLONE//Blog' className={({ isActive }) => (isActive ? activeDec : notActiveDec)}>
                     Blog
                  </NavLink>
                  <NavLink to='LOBE-CLONE//Help' className={({ isActive }) => (isActive ? activeDec : notActiveDec)}>
                     Help
                  </NavLink>
               </div>
               <button
