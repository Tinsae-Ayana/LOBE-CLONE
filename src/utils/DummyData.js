...
export const listofExamples = [
   ...
   {
      videoSrc: "src/assets/babyMonitoring.mp4",
   ...
   {
      videoSrc: "src/assets/smartCheckout.mp4",
   ...
   {
      videoSrc: "src/assets/wildlifeBehavior.mp4",
   ...
   {
      videoSrc: "src/assets/equipmentAnalytics.mp4",
   ...
   {
      videoSrc: "src/assets/telescopicImagery.mp4",
   ...
   {
      videoSrc: "src/assets/aerialImagery.mp4",
